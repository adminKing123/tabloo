  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-start gap-3 flex-1">
            ...
            <div className="flex-1">
              ...
              {currentProject.description && (
                <p className="text-gray-600 dark:text-gray-400 mt-1 break-words">{currentProject.description}</p>
              )}
            </div>
          </div>
        </div>
        ...
        {rootTables.length > 0 && (
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Tables</h3>
